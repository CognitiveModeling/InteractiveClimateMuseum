...
public class LanguageManager : MonoBehaviour
{
    void Awake()
    {
        // for each component in Panels and its children
        foreach (Component textComp in this.transform.GetComponentsInChildren<Component>(true))
        {
            ...
            if ((textComp.CompareTag("DE") && LanguageController.language == "en") || (textComp.CompareTag("EN") && LanguageController.language == "de"))
            {
