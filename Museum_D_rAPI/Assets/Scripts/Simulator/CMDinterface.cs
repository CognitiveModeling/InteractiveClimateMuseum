...
// This script is obsolete. It started the en_roads.exe which we used to look up temperature values in the API.
// In November 2023, we replaced it with the RestAPICallTest.cs which uses a more elegant way by startings a Rest API.
